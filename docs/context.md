...
2026-02-01 — v2.7.12: HTTP tool for web requests. Tool execution for non-tool-calling models, shared model definitions, configurable context size, memory reinforcement, tilde expansion.
